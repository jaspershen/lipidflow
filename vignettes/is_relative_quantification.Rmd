...
This step is used to get the relative quantification data of internal standards and lipids in all samples. If you have not finished the previous step, please click here: [Get retention time of internal standards](). 

If you have finished this step: click here to next step: [Absolute quantification]().
...
We need to get the sample information of samples. 
...
Then all the results are outputted into a folder `example/POS/is_relative_quantification`. The relative quantification table is `is_quantification_table.xlsx` and all the peak shapes are in `peak_shape`.
...
Next we need to get the relative quantification data of all lipids in all sample. Please click here: [Get relative quantification data of lipids](https://jaspershen.github.io/lipidflow/articles/lipids_relative_quantification.html)